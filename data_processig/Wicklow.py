...
class IrishClimbingRobust:
    ...
    def get_all_counties_and_sites_via_scraping(self):
        ...
        try:
            ...
            skip_pages = [
                'Recent changes', 'What links here', 'Related changes', 
                'Permanent link', 'Privacy policy', 'About', 'Disclaimers',
                'Irish Climbing Wiki', 'edit', 'search', 'Help', 'Special',
            ...
            for element in soup.find_all(['h1', 'h2', 'h3', 'ul', 'p']):
                if element.name in ['h1', 'h2', 'h3']:
                    ...
                    for link in links:
                        ...
                        href = link['href']
                        if any(skip in text for skip in skip_pages):
                            continue
    ...
    def _is_valid_climbing_site(self, text, href):
        ...
        exclude_texts = ['edit', 'search', 'category', 'file', 'template', 'user', 
                        ...
                        'Recent changes', 'What links here', 'Related changes', 
                        'Permanent link', 'Privacy policy', 'About', 'Disclaimers',
                        'Irish Climbing Wiki',"Disclaimers"]
