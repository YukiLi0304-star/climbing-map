...
class IrishClimbingRobust:
    def __init__(self):
        ...
        # 难度模式 - 用于识别路线
        self.grade_pattern = r'\b(MS|HS|HVS|VS|VD|HVD|Severe|Diff|VDiff|E[1-9](?:/[1-9])?|[4-6][abc]|S|D)\b'
    ...
    def extract_grid_ref_coords(self, wikitext):
        ...
        # 2. 转换为坐标
        coords = self._convert_gridref(grid_ref, county_name="Fermanagh")
        if coords:
