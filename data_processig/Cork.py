...
class IrishClimbingRobust:
    ...
    def _looks_like_grade(self, difficulty: str) -> bool:
        ...
        d = difficulty.strip()
        uk_trad_grades = {"M", "MS","D", "Severe", "VD", "Diff", "VDiff", "HVD", "S", "HS", "VS", "HVS", "E1", "E2", "E3", "E4", "E5", "E6", "E7", "E8", "E9"}
    ...
    def _parse_route_line(self, line: str):
        ...
        grade_patterns = ['E1','E2','E3', "Severe", 'E4','E5','E6','E7','HVS','VS','HS','S','VD','Diff','V.Diff', 'S.', 'M.S.','H.S.',]
    ...
    def get_climbing_routes_from_page(self, page_content):
        ...
        while i < len(lines):
            ...
            has_grade = any(g in line.upper() for g in ['E1','E2','HVS','VS','HS','S','VD'])
...
if __name__ == "__main__":
    ...
    test_county = "Cork"  # 你可以改成任何你想测试的郡名，比如 "kerry", "galway", "donegal" 等等
